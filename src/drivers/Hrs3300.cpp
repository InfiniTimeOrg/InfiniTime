...
void Hrs3300::Init() {
  ...
  // Wait time changed to zero and current to 12.5mA - Ceimour
  ...
  // Current 12.5mA and more magic (low nibble 0xF) - Ceimour
  ...
  // Gain set to 1x to improve signal/noise - Ceimour
