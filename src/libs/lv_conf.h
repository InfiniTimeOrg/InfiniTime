...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(noto_sans_bold_20) \
                               LV_FONT_DECLARE(noto_sans_extrabold_compressed) \
                               LV_FONT_DECLARE(noto_sans_42) \
                               LV_FONT_DECLARE(noto_sans_76) \
...
#define LV_THEME_DEFAULT_FONT_SMALL         &noto_sans_bold_20
#define LV_THEME_DEFAULT_FONT_NORMAL        &noto_sans_bold_20
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &noto_sans_bold_20
#define LV_THEME_DEFAULT_FONT_TITLE         &noto_sans_bold_20
