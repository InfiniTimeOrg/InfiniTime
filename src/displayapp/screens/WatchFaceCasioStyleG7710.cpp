...
WatchFaceCasioStyleG7710::WatchFaceCasioStyleG7710(DisplayApp* app,
  ...
  lv_mem_monitor(&mon);
  NRF_LOG_INFO("MEM1 : %d - %d", static_cast<int>(mon.free_biggest_size), mon.frag_pct)


  font_dot40 = lv_font_load("F:/lv_font_dots_40.bin");
  font_segment40 = lv_font_load("F:/lv_font_7segment_40.bin");
  font_segment115 = lv_font_load("F:/lv_font_7segment_115.bin");

  lv_mem_monitor(&mon);
  NRF_LOG_INFO("MEM2 : %d - %d", static_cast<int>(mon.free_biggest_size), mon.frag_pct)
