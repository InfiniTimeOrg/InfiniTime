...
void WatchFaceCasioStyleG7710::Refresh() {
  ...
  if (powerPresent.IsUpdated()) {
    ...
    printf("powerPresent: %s\npowerPresent.Get(): %s\nBatteryIcon::GetPlugIcon(powerPresent.Get()): %s\n( BatteryIcon::GetPlugIcon(powerPresent.Get()) == Symbols::plug ? 35 : 100 ): %s\n",
      powerPresent, powerPresent.Get(), BatteryIcon::GetPlugIcon(powerPresent.Get()), ( BatteryIcon::GetPlugIcon(powerPresent.Get()) == Symbols::plug ? 35 : 100 ))
