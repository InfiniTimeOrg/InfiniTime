...
Classes::Classes() {
  ...
  lv_obj_align(next_class_name, label, LV_ALIGN_OUT_BOTTOM_LEFT, 5, 5);
  ...
  lv_obj_align(next_class_loc, next_class_name, LV_ALIGN_OUT_BOTTOM_LEFT, 5, 5);
  ...
  lv_obj_align(next_class_start, next_class_loc, LV_ALIGN_OUT_BOTTOM_LEFT, 5, 5);
  ...
  lv_obj_align(next_class_end, next_class_start, LV_ALIGN_OUT_BOTTOM_LEFT, 5, 5);
  ...
  lv_obj_align(next_class_dif, next_class_end, LV_ALIGN_OUT_BOTTOM_LEFT, 5, 5);
