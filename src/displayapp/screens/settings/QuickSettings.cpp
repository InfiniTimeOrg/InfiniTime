...
QuickSettings::QuickSettings(Pinetime::Applications::DisplayApp* app,
  ...
  lv_style_set_bg_color(&btn_style, LV_STATE_DEFAULT, settingsController.getSurfaceColor());
  ...
  lv_obj_set_style_local_text_color(btn1_lvl, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, settingsController.getOnSurfaceColor());
  ...
  lv_obj_set_style_local_text_color(lbl_btn, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, settingsController.getOnSurfaceColor());
  ...
  lv_obj_set_style_local_bg_color(btn3, LV_BTN_PART_MAIN, LV_STATE_CHECKED, settingsController.getPrimaryColor());
  ...
  lv_obj_set_style_local_text_color(btn3_lvl, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, settingsController.getOnSurfaceColor());
  ...
  lv_obj_set_style_local_bg_color(label_time, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, settingsController.getBackgroundColor());
  lv_obj_set_style_local_bg_opa(label_time, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_100);
