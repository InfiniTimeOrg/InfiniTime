  ...
  namespace Applications {
    namespace Screens {
      ...
      private:
        ...
        std::vector<std::string> altTexts = {"https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                                             "++++[>++++<-]>+[>+++++>++++>++<<<-]>-.>++++.---.>--.<++.------.<-------.>++++.",
      ...
      private:
        ...
        constexpr static uint8_t intToAlpha[256] = {
        ...
        constexpr static uint8_t alphaToInt[256] = {
        ...
        constexpr static uint8_t generatorPolynomialAlpha[21] = {0,   17,  60, 79,  50,  61,  163, 26,  187, 202, 180,
