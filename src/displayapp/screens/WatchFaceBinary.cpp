		...
		motionController {motionController}
{
	...
	// !!! Achtung: alignments für alle folgenden Elemente ggfs im Hauptteil noch anpassen //
	/////////////////////////////////////////////////////////////////////////////////////////
	...
	lv_obj_align(label_test, lv_scr_act(), LV_ALIGN_CENTER, 10, 10);
	lv_obj_set_style_local_text_color(label_test, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0xCC00CC));	
	lv_label_set_text(label_test, "TEST");
	*/
	
	// !!! Achtung: alignments für alle vorangehenden Elemente ggfs im Hauptteil noch anpassen //
	/////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/	
	...
	lv_obj_align(monLED3, minLED3, LV_ALIGN_OUT_BOTTOM_MID, 0, (LED_SPACE_V2));	// 1/4 Kreis unter dayLED4	
