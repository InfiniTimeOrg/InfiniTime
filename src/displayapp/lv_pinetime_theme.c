...
static void basic_init(void) {
  ...
  lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, LV_PINETIME_BG);
  lv_style_set_bg_color(&style_btn, LV_STATE_CHECKED, LV_PINETIME_GREEN);
  lv_style_set_bg_color(&style_btn, LV_STATE_DISABLED, LV_PINETIME_BG_DISABLED);
  ...
  style_init_reset(&style_bar);
  lv_style_set_bg_opa(&style_bar, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_radius(&style_bar, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
  lv_style_set_bg_color(&style_bar, LV_STATE_DEFAULT, LV_COLOR_MAKE(0x20, 0x20, 0x20));

  style_init_reset(&style_bar_indic);
  lv_style_set_bg_opa(&style_bar_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_radius(&style_bar_indic, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
  ...
  lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_bg_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_COLOR_MAKE(0x2f, 0x35, 0x40));

  style_init_reset(&style_ddlist_selected);
  lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, LV_PINETIME_BG);

  style_init_reset(&style_sw_bg);
  lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, LV_COLOR_MAKE(0xd0, 0xd0, 0xd0));
  ...
  lv_style_set_line_color(&style_arc_indic, LV_STATE_DEFAULT, LV_COLOR_SILVER);
  ...
  lv_style_set_line_color(&style_arc_bg, LV_STATE_DEFAULT, LV_PINETIME_BG);
  ...
  lv_style_set_border_color(&style_cb_bullet, LV_STATE_CHECKED, LV_PINETIME_GREEN);
...
static void theme_apply(lv_obj_t* obj, lv_theme_style_t name) {
  ...
  switch (name_int) {
    ...
    case LV_THEME_BAR:
      ...
      _lv_style_list_add_style(list, &style_bar);
