...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3147, .adv_w = 280, .box_w = 17, .box_h = 11, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 3171, .adv_w = 280, .box_w = 17, .box_h = 11, .ofs_x = 0, .ofs_y = 2},
...
static const uint16_t unicode_list_2[] = {
    ...
    0x47, 0x4a, 0x4b, 0x4c, 0x50, 0x68, 0x6d, 0x76,
    0x77, 0x94, 0x128, 0x184, 0x1e5, 0x1fb, 0x200, 0x21d,
